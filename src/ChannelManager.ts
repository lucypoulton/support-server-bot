...
export class ChannelManager {
    ...
    async init(bot: Discord.Client): Promise<void> {
    ...
    constructor(bot: Discord.Client) {
        ...
        this.init(bot).then(_ => console.log("Finished caching channels"));
    }
    ...
    public closeTicket(channel: TextChannel): void {
        ...
        .then(chan => {
            chan.send(new Discord.MessageEmbed()
                ...
                .setColor("#ff77ff")
                .setDescription("React with \ud83d\udd13 to re-open or react with \ud83d\uddd1\ufe0f to delete")
            ).then(msg => {
                msg.react("\ud83d\udd13");
                msg.react("\ud83d\uddd1\ufe0f");
            })
