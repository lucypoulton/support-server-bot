...
import {AbstractRepositoryCommand} from "./AbstractRepositoryCommand";

export class SourceCommand extends AbstractRepositoryCommand {
    get name(): string {
        return "src";
    }

    protected execChannelAction(repo: string, args?: string[]): string | null {
        return `${repo}`;
    }
}